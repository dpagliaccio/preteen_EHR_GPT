...
# David Pagliaccio
# Feb 17, 2026
# This script runs LLM and RegEx identification of prior hospitalizations
...
***EXAMPLES**
- Note: "Patient had 3 PPH for suicidal ideation."  
  Output: Yes | 3 PPH for suicidal ideation
- Note: "No PPH or admissions recorded."  
  Output: No
- Note: "Recently transferred to the ED from Four Winds"  
  Output: Yes | Recently transferred to the ED from Four Winds
- Note: "PPH of MDD and ADHD, no prior suicide attempts"
  Output: No
- Note: "today is pt's first time receiving psychiatric care"  
  Output: No
- Note: "pt reports no PPHosp/SA, one recent ED visit last August"  
  Output: Yes | one recent ED visit
- Note: "sees psychiatrist monthly, 3 known prior IP admissions"  
  Output: Yes | 3 known prior IP admissions
- Note: "I recommend patient be referred for inpatient psychiatric hospitalization"
  Output: No
- Note: "patient requires inpatient psychiatric admission for stabilization and safety"
  Output: No
...
output_file = os.path.join(script_dir, "/data/ehr_priorhosp_out.csv")
